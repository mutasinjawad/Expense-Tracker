        ...
        <div className='w-full h-full bg-white rounded-xl flex flex-col items-start justify-start p-6'>
            ...
            <form className='w-full flex flex-col gap-4' onSubmit={handleSubmit}>
                ...
                <div className='flex gap-6'>
                    <div className='w-full text-center bg-zinc-700 text-zinc-200 font-semibold py-2 px-4 rounded-lg hover:bg-zinc-900 transition-all duration-200' onClick={() => setAddFormOpen(false)}>Cancel</div>
